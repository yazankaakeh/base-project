                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center pb-2 mb-1">
                            <h5 class="mb-0">{{ trans('adminmanagement::admin_management.user.title') }}</h5>
                            @can('admin.user_management.store')
                                <button type="button"
                                        data-bs-toggle="modal" data-bs-target="#storeModal"
                                        class="btn btn-primary">
                                    <i class="ti tabler-plus me-1"></i>
                                    {{ trans('adminmanagement::admin_management.user.create') }}
                                </button>
                            @endcan
                        </div>
                        <div class="card-body">
                                ...
                                <div class="table-responsive text-nowrap">
                                    <table class="table datanew">
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ trans('adminmanagement::admin_management.user.email') }}</th>
                                            <th>{{ trans('adminmanagement::admin_management.user.role') }}</th>
                                            <th>{{ trans('adminmanagement::admin_management.user.image') }}</th>
                                            <th>{{ trans('adminmanagement::admin_management.user.status') }}</th>
                                            <th>{{ trans('adminmanagement::admin_management.user.actions') }}</th>
                                        </tr>
                                        </thead>
                                        ...
                                        @foreach($users as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                                        <li class="avatar avatar-xl pull-up"
                                                            ...
                                                            <img src="{{ $user->img ? asset('storage/'.$user->img) : asset('codliy/images/avatar-fallback.png') }}"
                                                                 alt="{{ $user->name }}"
                                                ...
                                                <td>
                                                    <span class="badge text-bg-{{ $user->is_active?->class() ?? 'secondary' }} me-1">
