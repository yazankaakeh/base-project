    ...
    <div class="row mb-5">
                        ...
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item">
                                <a href="javascript:void(0);" class="card-collapsible"><i
                                            class="tf-icons ti tabler-chevron-right scaleX-n1-rtl ti-sm"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="collapse show">
                    <div class="card-body">
                        ...
                        <p class="card-text d-flex align-items-center gap-1">Click on <i
                                    class="tf-icons ti tabler-chevron-right scaleX-n1-rtl"></i> to see card collapse in
                            action.</p>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item">
                                <a href="javascript:void(0);" class="card-reload"><i
                                            class="tf-icons ti tabler-rotate-clockwise-2 scaleX-n1-rtl ti-sm"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="col-md">
            <div class="card card-action mb-4">
                ...
                <div class="card-body">
                    <p class="card-text">Remove card action hide the card, use <code>.card-close</code> class with
                        action item.
                    </p>
                    <br/>
                    <p class="card-text d-flex align-items-center gap-1">Click on <i class="tf-icons ti ti-x"></i> icon
                        to see
