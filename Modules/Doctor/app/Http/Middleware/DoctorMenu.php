...
class DoctorMenu
{
    ...
    private function getMenuData(): array
    {
        return [
            ...
            [
                "name" => trans("admin.sidebar.medicalPreviewSettings"),
                "icon" => "menu-icon tf-icons ti tabler-smart-home",
                "slug" => "dashboard",
                "url" => "dashboard",
                "submenu" => [
                    [
                        ...
                        "name" => trans("admin.sidebar.clinic"),
