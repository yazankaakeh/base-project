...
@section('title', $category->getTranslation('title', app()->getLocale()))
        ...
        <div class="container">
            ...
            <div class="row justify-content-center mb-10">
                <div class="col-lg-8 text-center">
                    @if($category->getFirstMediaUrl('img'))
                        <img src="{{ $category->getFirstMediaUrl('img') }}"
                             alt="{{ $category->getTranslation('title', app()->getLocale()) }}"
                             class="rounded-circle mb-4" width="120" height="120" style="object-fit: cover;">
                    @endif
                                ...
                                @foreach($categories as $cat)
                                    <li class="mb-2">
                                        <a href="{{ route('blog.category', $cat->id) }}"
                                           class="d-flex align-items-center {{ $category->id == $cat->id ? 'text-primary fw-medium' : '' }}">
                                            <i class="ti tabler-folder me-2"></i>
                                            {{ $cat->getTranslation('title', app()->getLocale()) }}
                                            <span class="badge bg-label-secondary ms-auto">{{ $cat->posts()->count() }}</span>
                                        </a>
                                    </li>
                                @endforeach
                            </ul>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body text-center py-10">
                                        ...
                                        <h5>{{__('No posts found in this category')}}</h5>
