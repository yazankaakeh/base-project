                                    ...
                                    <table class="table datanew">
                                        ...
                                        @foreach($data as $category)
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                                        <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                            ...
                                                            aria-label="{{ $category->getTranslation('title', app()->getLocale()) }}"
                                                            data-bs-original-title="{{ $category->getTranslation('title', app()->getLocale()) }}">
                                                ...
                                                <td>
                                                    <span class="badge text-bg-{{ $category->is_active->class() }} me-1">{{ $category->is_active->label() }} </span>
                                                </td>
