          ...
          <div class="mb-3">
            <div class="card-header pt-1">
              <ul class="nav nav-tabs card-header-tabs" role="tablist">
                ...
                <li class="nav-item">
                  <button type="button" data-bs-target="#tr" aria-controls="tr" class="nav-link" data-bs-toggle="tab"
                ...
                <div class="tab-pane fade" id="ar" role="tabpanel">
                  <div class="row">
                    <x-blog::inputMultiLanguageComponent divClass="col-lg-12 col-sm-12 col-md-6 mb-3"
                                                         label="Name"
                                                         name="name"
                                                         type="text" id="name" language="ar" />
                    <x-blog::textareaMultiLanguageComponent divClass="col-lg-12 col-sm-12 col-md-6 mb-3"
                                                            label="Description"
                                                            name="description"
                                                            type="text" id="description" language="ar" />
                  </div>
                </div>
