...
<div class="header">
    ...
    <div class="header-left active">
        <a href="{{ route('user.dashboard.index') }}" class="logo logo-normal">
            <img src="{{ URL::asset('/build/img/logo.png') }}" alt="">
        </a>
        <a href="{{ route('user.dashboard.index') }}" class="logo logo-white">
            <img src="{{ URL::asset('/build/img/logo-white.png') }}" alt="">
        </a>
        <a href="{{ route('user.dashboard.index') }}" class="logo-small">
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow flag-nav nav-item-box">
            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);" role="button">
                <img src="{{ URL::asset('/build/img/flags/'. app()->getLocale().'.png') }}"
                     alt="Language"
                     class="img-fluid">
            </a>
            <div class="dropdown-menu dropdown-menu-right">
                <a href="{{route('localeRoute',['locale' => 'en'])}}"
                   class="dropdown-item {{app()->getLocale() == 'en' ? 'active' : '' }}">
                    <img src="{{ URL::asset('/build/img/flags/us.png') }}" alt="" height="16">
                    English
                </a>
                <a href="{{route('localeRoute',['locale' => 'tr'])}}"
                   class="dropdown-item {{app()->getLocale() == 'tr' ? 'active' : '' }}">
                    <img src="{{ URL::asset('/build/img/flags/tr.png') }}" alt="" height="16">
                    Turkish
                </a>
            </div>
        </li>
            ...
            <div class="dropdown-menu menu-drop-user">
                <div class="profilename">
                    <div class="profileset">
                        <span class="user-img"><img src="{{Auth::user()->img}}"
                                                    alt="">
