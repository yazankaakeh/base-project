        ...
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <i class="ti tabler-settings tabler-xl me-3"></i>
                  <span>
                        ...
                        <div class="form-check custom-option custom-option-basic">
                            <label class="form-check-label custom-option-content ps-3" for="customRadioTemp2"
                                ...
                                <input name="customRadioTemp" class="form-check-input d-none" type="radio" value=""
                                       id="customRadioTemp2"/>
                                <span class="d-flex align-items-start">
                  <i class="ti tabler-message tabler-xl me-3"></i>
                  <span>
                    <span class="custom-option-header">
            ...
            <div class="modal-body">
                ...
                <div class="text-end">
                    <button type="button" class="btn btn-label-secondary me-sm-3 me-1" data-bs-toggle="modal"
                            data-bs-target="#twoFactorAuth"><i
                                class="ti tabler-arrow-left ti-xs me-1 scaleX-n1-rtl"></i><span
                    ...
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" aria-label="Close"><span
                                ...
                                class="ti tabler-arrow-right ti-xs ms-1 scaleX-n1-rtl"></i></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-simple">
        <div class="modal-content p-3 p-md-5">
            <div class="modal-body">
                ...
                <p class="mb-4">Enter your mobile phone number with country code, and we will send you a verification
                    code.</p>
                <div class="mb-4">
