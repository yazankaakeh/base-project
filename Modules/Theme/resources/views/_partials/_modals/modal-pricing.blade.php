            ...
            <div class="modal-body">
                ...
                <span class="switch-off"></span>
                        ...
                        <div class="mt-n5 ms-n5 d-none d-sm-block">
                            <i class="ti tabler-corner-left-down ti-sm text-muted me-1 scaleX-n1-rtl"></i>
                            ...
                            <div class="card border rounded shadow-none">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-label-success d-grid w-100 mt-3"
                                            data-bs-dismiss="modal">Your Current Plan
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl">
                            <div class="card border rounded shadow-none">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-label-primary d-grid w-100 mt-3"
                                            data-bs-dismiss="modal">Upgrade
                                    </button>
                                </div>
                            </div>
