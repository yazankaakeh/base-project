                    ...
                    <div class="col-xl-8 mb-3 mb-xl-0">
                        ...
                        <div class="alert alert-success mb-3" role="alert">
                            <div class="d-flex gap-3">
                                <div class="flex-shrink-0">
                                    <i class="ti tabler-bookmarks ti-sm alert-icon alert-icon-lg"></i>
                                </div>
                                <div class="flex-grow-1">
                                    <div class="fw-medium fs-5 mb-2">Available Offers</div>
                                    <ul class="list-unstyled mb-0">
                                        <li> - 10% Instant Discount on Bank of America Corp Bank Debit and Credit
                                            cards
                                        </li>
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="text-muted mb-2 d-flex flex-wrap"><span class="me-1">Sold by:</span>
                                                    <a
                                                            href="javascript:void(0)" class="me-3">Apple</a> <span
                                                            class="badge bg-label-success">In Stock</span>
                                                </div>
                            ...
                            <li class="list-group-item p-4">
                                <div class="d-flex gap-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <p class="me-3"><a href="javascript:void(0)" class="text-body">Apple
                        ...
                        <div class="list-group">
                            <a href="javascript:void(0)" class="list-group-item d-flex justify-content-between">
                                ...
                                <i class="ti ti-sm tabler-chevron-right scaleX-n1-rtl"></i>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="border rounded p-4 pb-3 mb-3">
                            ...
                            <ul class="list-unstyled">
                                <li class="d-flex gap-3 align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <p class="mb-0"><a class="text-body" href="javascript:void(0)">Google - Google
                                                Home - White</a></p>
                    ...
                    <div class="col-xl-8 col-xxl-9 mb-3 mb-xl-0">
                        ...
                        <div class="col-xxl-6 col-lg-8">
                          ...
                          <span class="switch-off"></span>
                                        ...
                                        <div class="col-12">
                                            <button type="button" class="btn btn-primary btn-next me-sm-3 me-1">Submit
                                            </button>
                                ...
                                <div class="tab-pane fade" id="pills-gift-card" role="tabpanel"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <button type="button" class="btn btn-primary btn-next">Redeem Gift Card
                                            </button>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row mb-3">
                    <div class="col-12 col-lg-8 mx-auto text-center mb-3">
                        ...
                        <p>We sent an email to <a href="mailto:john.doe@example.com">john.doe@example.com</a> with your
                            order
                            confirmation and receipt. If the email hasn't arrived within two minutes, please check your
                            spam folder to
                            see if the email was routed there.</p>
                        <p><span class="fw-medium"><i class="ti ti-clock me-1"></i> Time placed:&nbsp;</span> 25/05/2020
                            13:35pm</p>
                    </div>
                    ...
                    <div class="col-12">
                        <ul class="list-group list-group-horizontal-md">
                            ...
                            <li class="list-group-item flex-fill p-4 text-heading">
                                <h6 class="d-flex align-items-center gap-1"><i class="ti ti-credit-card"></i> Billing
                                    Address</h6>
                                <address class="mb-0">
                                    John Doe <br/>
                                    4135 Parkway Street,<br/>
                            ...
                            <li class="list-group-item flex-fill p-4 text-heading">
                                <h6 class="d-flex align-items-center gap-1"><i class="ti ti-ship"></i> Shipping Method
                                </h6>
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="text-muted mb-1 d-flex flex-wrap"><span class="me-1">Sold by:</span>
                                                    <a
                                                            href="javascript:void(0)" class="me-3">Apple</a> <span
                                                            class="badge bg-label-success">In Stock</span>
                                                </div>
