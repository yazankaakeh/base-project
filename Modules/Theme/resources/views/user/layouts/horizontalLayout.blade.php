...
@section('layoutContent')
  <div class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
    <div class="layout-container">
      ...
      <!-- BEGIN: Navbar-->
      @if ($isNavbar)
        @includeIf('customer/layouts/sections/navbar/navbar')
      @endif
      <!-- END: Navbar-->
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          @if ($isMenu)
            @includeIf('customer/layouts/sections/menu/horizontalMenu')
          @endif
          ...
          @if ($isFlex)
            <div class="{{ $container }} d-flex align-items-stretch flex-grow-1 p-0">
              @else
                ...
                <!-- Footer -->
                @if ($isFooter)
                  @includeIf('customer/layouts/sections/footer/footer')
                @endif
                <!-- / Footer -->
