...
@endphp
        <!-- laravel style -->
@vite(['resources/assets/vendor/js/helpers.js'], 'build/modules/theme')
<!-- beautify ignore:start -->
@if ($configData['hasCustomizer'])
    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Template customizer: To hide customizer set displayCustomizer value false in config.js.  -->
    @vite(['resources/assets/vendor/js/template-customizer.js'], 'build/modules/theme')
@endif

<!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
@vite(['resources/assets/js/config.js'], 'build/modules/theme')
            ...
            if (window.TemplateCustomizer) {
                try {
                    ...
                    window.templateCustomizer = new TemplateCustomizer({
                        ...
                        lang: '{{ app()->getLocale() }}',
                        'controls': <?php
                                        echo json_encode($configData['customizerControls']); ?>,
                    });
