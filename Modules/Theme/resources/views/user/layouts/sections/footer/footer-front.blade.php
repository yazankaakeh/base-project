      ...
      <div class="row gx-0 gy-6 g-lg-10">
        ...
        <div class="col-lg-2 col-md-4 col-sm-6">
          <h6 class="footer-title mb-6">
            {{trans('newLandingPage.footer.pages.title')}}
          </h6>
          <ul class="list-unstyled">
            <li class="mb-4">
              <a href="#landingFeatures" class="footer-link">
                {{trans('newLandingPage.footer.pages.features')}}
              </a>
            </li>
            <li class="mb-4">
              <a href="#theHow" class="footer-link">
                {{trans('newLandingPage.footer.pages.theHow')}}
              </a>
            </li>
            <li class="mb-4">
        ...
        <div class="col-lg-2 col-md-4 col-sm-6">
          <h6 class="footer-title mb-6">
            {{trans('newLandingPage.footer.products.title')}}
          </h6>
          <ul class="list-unstyled">
            <li class="mb-4">
              <a href="#" class="footer-link">
                {{trans('newLandingPage.footer.products.cards')}}
              </a>
            </li>
            <li class="mb-4">
              <a href="#" class="footer-link">
                {{trans('newLandingPage.footer.products.more')}}
              </a>
            </li>
  ...
  <div class="footer-bottom py-3 py-md-5">
    <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
      <div class="mb-2 mb-md-0">
        ...
        <span class="footer-bottom-text"> {{trans('newLandingPage.footer.madeWithLove')}}</span>
      </div>
      <div>
