...
return [
    ...
    'contact_us' => [
        ...
        'subtitle' => 'Web sitesi iletişim formundan gönderilen tüm mesajlar.',
        'search' => 'İsim, e-posta veya mesajda ara',
        ...
        'received' => 'Alındı',
        'actions' => 'İşlemler',
        'details' => 'Mesaj detayları',
        'reply' => 'E-posta ile yanıtla',
        'back' => 'Gelen kutusuna dön',
        'delete' => 'Mesajı sil',
        'delete_confirm' => 'Bu mesajı silmek istediğinize emin misiniz?',
        'submitted' => 'Teşekkürler! Mesajınız alındı.',
        'deleted' => 'Mesaj silindi.',
        'no_results' => 'Aramanıza uyan mesaj yok.',
        'empty' => 'Henüz mesaj yok.',
        'empty_hint' => 'Genel iletişim formu gönderileri burada görünecek.',
        'stats' => [
            'total' => 'Toplam mesaj',
            'this_week' => 'Son 7 gün',
            'today' => 'Bugün',
            'unique_from' => 'Tekil gönderenler',
        ],
    ],
