...
class EnvUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            // Email Settings
            'recaptcha' => 'nullable|bool',
            'RECAPTCHA_SITE_KEY' => 'required_if:recaptcha=1|string',
            'RECAPTCHA_SECRET_KEY' => 'required_if:recaptcha=1|string',
            'RECAPTCHA_LINK' => 'required_if:recaptcha=1|string',
            // Email Settings
            'mail' => 'nullable|bool',
