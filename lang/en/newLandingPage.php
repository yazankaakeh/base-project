...
Messages sent through contact and quote forms
Usage data from our website (cookies, analytics)
2. How We Use It
To respond to inquiries and deliver contracted services
To manage accounts, projects and invoices
To improve our website, services and security posture
3. Data Sharing
We do not sell your data.
We only share information with sub-processors (hosting, analytics, email) under contract and only as needed to deliver the service.
4. Your Rights
You can request to access, correct, export or delete your data.
You can unsubscribe from any marketing email at any time.
5. Data Security
We follow industry-standard security practices, including encryption in transit, least-privilege access and regular dependency reviews.
...
You are responsible for timely reviews, approvals and payments as defined in the SOW.
2. Acceptable Use
No illegal activity, reverse engineering of our proprietary tooling, or resale of deliverables outside the agreed scope.
3. Intellectual Property
Upon full payment, the client owns the custom code delivered for their project, except for pre-existing Codliy internal libraries which remain ours and are licensed for use within the delivered product.
4. Third-Party Services
We may integrate third-party services (cloud, analytics, payments). You are bound by their terms.
5. Service Disclaimer
Services are provided with reasonable professional care but without implied warranties beyond what is written in the SOW.
